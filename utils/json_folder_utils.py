...
def check_unique_name(json_file, name_folder):
    """Checks if the name_folder is unique in the JSON file."""
    data = load_data(json_file)
    return name_folder not in data

# Function to check if the folder paths in the JSON file exist
def validate_folders_in_json(json_file='simulation_folders.json'):
